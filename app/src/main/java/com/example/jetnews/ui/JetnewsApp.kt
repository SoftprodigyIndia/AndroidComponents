...
//                is.Screen.ProfileActivity -> ProfileActivity()
...
fun AppDrawer(
    ...
    Column(modifier = LayoutSize.Fill) {
        ...
        DrawerButton(icon = R.drawable.ic_account_circle_black,
            label ="Profile" ,
            isSelected = currentScreen == Screen.ProfileActivity
            ){
            navigateTo(Screen.ProfileActivity)
            closeDrawer()
        }
    }
}
